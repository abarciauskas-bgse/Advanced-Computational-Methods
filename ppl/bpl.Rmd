...
boxplot(int.lengths.mat$num.pixels ~ int.lengths.mat$label, pch = 19, col = alpha(colors[[9]], 0.1))
```
...
thinned.ints.with.paths <- generatePaths(thinned.ints[rand.idcs[7]], animation = TRUE, sleep.time = 0.33)
